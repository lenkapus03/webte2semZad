...
try {
    ...
    echo '</head><body>';
    echo '<h1>PDF Split Download Error</h1>';
    ...
    echo '<ol>';
    echo '<li>Go back to the <a href="/myapp/frontend/split_pdfs.html">PDF Splitter page</a> and try again</li>';
    echo '<li>Make sure to download the ZIP file immediately after splitting</li>';
    ...
    error_log('PDF Split Download Error: ' . $e->getMessage());
    exit;
}