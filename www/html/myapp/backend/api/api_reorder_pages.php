...
try {
    ...
    switch ($_SERVER['REQUEST_METHOD']) {
        case 'GET':
            ...
            $response = [
                'success' => true,
                'endpoint' => 'PDF Reorder Pages API',
                'description' => 'API for reordering pages in a PDF file',
                'methods' => [
                    'GET' => 'Get information about this API endpoint',
                    'POST' => 'Upload a PDF file to reorder pages'
                ],
                'post_parameters' => [
                    'file' => 'Single PDF file to process',
                    'page_order' => 'JSON array of page numbers in the new order (1-based)'
                ],
                'post_response' => [
        ...
        case 'POST':
            // Forward the request to the reorder_pages.php script
            ...
            // Check for page_order parameter
    ...
    error_log('PDF Reorder Pages API Error: ' . $t->getMessage());
}
